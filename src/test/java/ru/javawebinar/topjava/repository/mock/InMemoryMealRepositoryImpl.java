...
public class InMemoryMealRepositoryImpl implements MealRepository {
    ...
    private static final Comparator<Meal> MEAL_COMPARATOR = Comparator.comparing(Meal::getDateTime).thenComparing(Meal::getId).reversed();
    ...
    public void clear() {
        repository.clear();
        counter = new AtomicInteger(START_SEQ + 1);
    }
}
